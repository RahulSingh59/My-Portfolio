...
import Tableau from "../../img/TP.PNG";
    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>
            Software Engineer with 1.8 years of experience in web designing
            and development, Testing , producting the Quality work
          </span>
        </div>
        ...
        <div className="i-icons">
          <a href="https://github.com/RahulSingh59" target="_blank" rel="noreferrer">
          <img src={Github} alt="" />
          </a>
